...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="">发票审批列表</a></li>
	</ul>
		...
		<tbody>
		  <c:forEach items="${reciepts}" var="reciept">
			<tr>
				...
				<td>
    				<a href="${pageContext.request.contextPath}/reciept/apply/${reciept.receipt_id}">审批</a>
    				<a href="${pageContext.request.contextPath}/reciept/advice/${reciept.receipt_id}">意见</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
