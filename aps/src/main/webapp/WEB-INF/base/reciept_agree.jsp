...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="">发票申请单通过列表</a></li>
			
	</ul>
	
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>发票类别</th><th>是否已收款</th><th class="sort-column login_name">收款方式</th><th class="sort-column name">收款时期</th><th>客户名称</th><th>税号</th><th>地址电话</th><th>开户行账号</th><th>产品名称</th><th>开票内容</th><th>开票金额</th><th>备注</th></tr></thead>
		<tbody>
